...
pub const ENNEAGRAM_PERSONALITY_TEST: Scale<Interpretation, Question> = Scale {
    ...
    interpretation: Interpretation { 
        dialog: &[
            "人格最健康的时候，随时有人格整合的可能，例如：第9型的出现了第3型的特征，由原本的内向保守，变得充满活力，基本欲望得到满足，基本恐惧隐藏。健康的人格令人活出真我，心理平衡、充分发挥自己的潜能和能力对社会作出贡献。",
        ...
        type_interpretations:  &[
            ...
            TypeInterpretation {
                ...
                relationships: "成就型(Achiever)你精力充沛，总是动力过人，因为你有很强的争胜欲望！你喜欢接受挑战，会把你自己的价值与成就连成一线。成就型的你会全心全意去追求一个目标，因为你相信「天下没有不可能的事」。动力十足的你，最好做leader带领其他人啦！",
                characters: &[
                    Character {
                        keyword: "自恋、炫耀",
            ...
            TypeInterpretation {
                ...
                relationships: "理智型(Thinker)你是个很冷静的人，总想跟身边的人和事保持一段距离，也不会让情绪左右。很多时候，你都会先做旁观者，后才投入参与。另外，你也需要充分的私人空间和高度的私隐，否则你会觉得很焦虑，不安定！你也很有机会成为专家，例如电脑啦，漫画啦，时装啦，因为你对知识是非常热爱的！",
                characters: &[
                    Character {
                        keyword: "好辨、抽离",
            ...
            TypeInterpretation {
                ...
                relationships: "忠诚型(Loyalist)你会是一个很好员工，因为你很忠心尽责。安全感对你都很重要，因为当遇到新的人和事，都会令你产生恐惧、不安的感觉。基于这种恐惧不安，凡事你都会作最坏打算，换句话说，你为人都比较悲观，也较易去逃避了事。",
                characters: &[
                    Character {
                        keyword: "害怕、忧虑、犹豫",
            ...
            TypeInterpretation {
                ...
                relationships: "活跃型(Adventurer)活跃型的你，就是如此这般：乐观、精力充沛、迷人、好动、贪新鲜、五时花六时变……「最近要玩得开心」就是你的生活哲学！你们很需要生活有新鲜感，所以很不喜欢被束缚、被控制。你的活力是玩的活力，又跟第三型的成就型又有所不同，相信你们是活动搅手，玩极唔厌！",
                characters: &[
                    Character {
                        keyword: "不耐烦、冲动、上瘾",
